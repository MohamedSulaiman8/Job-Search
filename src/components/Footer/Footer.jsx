...
export default function Footer(){
    return(
        <div className="bg-blueColor footer mb-4 p-[5rem] rounded-[10px] gap-[8px] grid
        grid-cols-5 m-auto items-top justify-center">
            <div>
                <div className="logoDiv">
                    <h1 className="logo text-[25px] text-white pb-[1.5rem]"><strong>Job</strong>Search</h1>
                </div>
                <p className="text-white pb-[13px] opacity-70 leading-7">We always make our seekers and companies find teh best jobs and employers find the best candidates</p>
            </div>
            <div className="grid">
            ...
            <div className="grid">
                ...
                <small className="text-[14px] text-white">jobsearch7@gmail.com</small>
